...
public class MyMQAdminExt extends ClientConfig implements MQAdminExt {
    private final MyMQAdminExtImpl defaultMQAdminExtImpl;
    private String adminExtGroup = "admin_ext_group";
    private String createTopicKey = TopicValidator.AUTO_CREATE_TOPIC_KEY_TOPIC;
    private long timeoutMillis = 5000;

    public MyMQAdminExt() {
        this.defaultMQAdminExtImpl = new MyMQAdminExtImpl(this, null, timeoutMillis);
    }

    public MyMQAdminExt(long timeoutMillis) {
        this.defaultMQAdminExtImpl = new MyMQAdminExtImpl(this, null, timeoutMillis);
    }

    public MyMQAdminExt(RPCHook rpcHook) {
        this.defaultMQAdminExtImpl = new MyMQAdminExtImpl(this, rpcHook, timeoutMillis);
    }

    public MyMQAdminExt(RPCHook rpcHook, long timeoutMillis) {
        this.defaultMQAdminExtImpl = new MyMQAdminExtImpl(this, rpcHook, timeoutMillis);
    }

    public MyMQAdminExt(RPCHook rpcHook, long timeoutMillis, RMQConfigure configure) {
        this.defaultMQAdminExtImpl = new MyMQAdminExtImpl(this, rpcHook, timeoutMillis, configure);
    }

    public MyMQAdminExt(final String adminExtGroup) {
        this.adminExtGroup = adminExtGroup;
        this.defaultMQAdminExtImpl = new MyMQAdminExtImpl(this, timeoutMillis);
    }

    public MyMQAdminExt(final String adminExtGroup, long timeoutMillis) {
        this.adminExtGroup = adminExtGroup;
        this.defaultMQAdminExtImpl = new MyMQAdminExtImpl(this, timeoutMillis);
    }
