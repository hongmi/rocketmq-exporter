...
public class MyMQAdminExtImpl implements MQAdminExt, MQAdminExtInner {
    private final InternalLogger log = ClientLogger.getLog();
    private final MyMQAdminExt defaultMQAdminExt;
    ...
    public MyMQAdminExtImpl(MyMQAdminExt defaultMQAdminExt, long timeoutMillis) {
        this(defaultMQAdminExt, null, timeoutMillis);
    }
    public MyMQAdminExtImpl(MyMQAdminExt defaultMQAdminExt, RPCHook rpcHook, long timeoutMillis) {
        this.defaultMQAdminExt = defaultMQAdminExt;
        this.rpcHook = rpcHook;
        this.timeoutMillis = timeoutMillis;
    }

    public MyMQAdminExtImpl(MyMQAdminExt defaultMQAdminExt, RPCHook rpcHook, long timeoutMillis, RMQConfigure configure) {
        this.defaultMQAdminExt = defaultMQAdminExt;
        this.rpcHook = rpcHook;
        this.timeoutMillis = timeoutMillis;
        this.rmqConfigure = configure;
    }
    ...
    public TopicStatsTable examineTopicStats(
        ...
        for (BrokerData bd : topicRouteData.getBrokerDatas()) {
            ...
            addr = rmqConfigure.getBrokerIPalias(addr);
            if (addr != null) {
    ...
    public boolean consumed(final MessageExt msg,
        ...
        Iterator<Map.Entry<MessageQueue, OffsetWrapper>> it = cstats.getOffsetTable().entrySet().iterator();
        while (it.hasNext()) {
            Map.Entry<MessageQueue, OffsetWrapper> next = it.next();
